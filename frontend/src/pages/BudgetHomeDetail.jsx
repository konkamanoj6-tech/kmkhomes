...
import { ChevronLeft, ChevronRight, MapPin, Home as HomeIcon, Ruler, Compass, Phone, Mail, MessageCircle, ArrowLeft, Check, Expand } from 'lucide-react';
...
const BudgetHomeDetail = () => {
  ...
  }, [showImageModal, modalImageIndex, home?.gallery_images?.length]);

  const fetchHome = async () => {
    try {
      const response = await publicApi.getBudgetHome(id);
      setHome(response.data);
    } catch (error) {
      console.error('Error fetching budget home:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-lg text-gray-600">Loading home details...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-600 mb-4">Home Not Found</h1>
          <Link to="/projects/homes-for-every-budget" className="text-emerald-600 hover:underline">
            Back to Budget Homes
          </Link>
        </div>
      </div>
    );
  ...
  const allImages = [home.main_image, ...(home.gallery_images || [])];
  ...
  const youtubeVideoId = getYouTubeVideoId(home.youtube_link);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <Link 
            to="/projects/homes-for-every-budget" 
            ...
            <Card className="overflow-hidden">
              <div className="relative">
                <img
                  ...
                  alt={`${home.property_name} - ${currentImageIndex + 1}`}
                  ...
                  {allImages.map((img, idx) => (
                    <img
                      ...
                      className={`w-full h-20 object-cover rounded cursor-pointer transition ${
                        idx === currentImageIndex ? 'ring-2 ring-emerald-500' : 'opacity-60 hover:opacity-100'
                      }`}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{home.property_type}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{home.built_up_area}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{home.facing}</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-6xl">
            <img
              ...
              alt={`${home.property_name} - ${modalImageIndex + 1}`}
...
export default BudgetHomeDetail;
